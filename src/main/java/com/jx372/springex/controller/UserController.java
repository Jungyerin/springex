...
public class UserController {
	...
	@RequestMapping( value={"/login", "/l"}, method=RequestMethod.GET) //2개 이상은 이름을 반드시 적어줘야함.
	public String login(){			
...
//			@RequestParam( value="password", required=true, defaultValue="")
			@ModelAttribute UserVo uservo){			/*set을 해주지 않아도 어노테이션을 이용해서 통째로 객체를 가지고 올 수 있다. uservo의 변수 이름과 폼의 이름이 같아야 가능.*/		
